...
START TRANSACTION;
USE `setofskillsdb`;
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (1, 'Knot Req 1', 'Learn to tie 5 knots.', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (2, 'Knot Req 2', 'Teach someone to tie 5 knots', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (3, 'Knot Req 3', 'Learn to tie 15 knots', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (4, 'Chess Req 1', 'Learn chess rules and board setup', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (5, 'Chess Req 2', 'Play 3 full games', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (6, 'Chess Req 3', 'Win 5 games', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (7, 'Tent Req 1', 'Setup a tent', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (8, 'Tent Req 2', 'Teach someone how to setup a tent', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (9, 'Tent Req 3', 'Spend one night in tent', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (10, 'Garden Req 1', 'Setup Garden', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (11, 'Garden Req 2', 'Grow 1 plant', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (12, 'Garden Req 3', 'Grow 5 plants', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (13, 'Money Req 1', 'Save $10', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (14, 'Money Req 2', 'Save $50', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (15, 'Money Req 3', 'Setup a bank account', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (16, 'Laundry Req 1', 'Accumulate some dirty clothing', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (17, 'Laundry Req 2', 'Complete a Single load of laundry or handwash ', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (18, 'Laundry Req 3', 'Complete 5 loads of laundry', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (19, 'Gift Req 1', 'Find someone deserving a present', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (20, 'Gift Req 2', 'Learn how to get gift ideas', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (21, 'Gift Req 3', 'Give 3 gifts', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (22, 'Map Req 1', 'Learn the information in a map', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (23, 'Map Req 2', 'Learn map orientation and how to follow a map', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (24, 'Map Req 3', 'Take map on a road trip or hiking trail', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (25, 'Bread Req 1', 'Make one loaf', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (26, 'Bread Req 2', 'Make 3 loaves', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (27, 'Bread Req 3', 'Make 5 loaves', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (28, 'Cleaning Req 1', 'Learn about different cleaning equipment and safety', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (29, 'Cleaning Req 2', 'Clean your room', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (30, 'Cleaning Req 3', 'Keep room clean for 1 week', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (31, 'Fishing Req 1', 'Gather supplies and find a fishing spot.', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (32, 'Fishing Req 2', 'Catch one fish', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (33, 'Fishing Req 3', 'Catch 3 fishes', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (34, 'Singing Req 1 ', 'Sing a long to one song', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (35, 'Singing Req 2', 'Sing Karaoke', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (36, 'Singing Req 3', 'Sing in front of a crowd', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (37, 'Dancing Req 1', 'Dance in your house', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (38, 'Dancing Req 2', 'Dance in Public', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (39, 'Dancing Req 3', 'Dance like justin', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (40, 'Hiking Req 1', 'Learn Hiking safety', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (41, 'Hiking Req 2', 'Hike easy trail', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (42, 'Hiking Req 3', 'Hike 5 miles', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (43, 'Goal Req 1', 'Set and meet a goal', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (44, 'Goal Req 2', 'Set and meet 10 goals', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (45, 'Goal Req 3', 'Set and meet 20 goals', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (46, 'Sewing Req 1', 'Sew a button', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (47, 'Sewing Req 2', 'Patch something', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (48, 'Sewing Req 3', 'Adjust a piece of clothing to size', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (49, 'Selling Req 1', 'Sell one item', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (50, 'Selling Req 2', 'Sell 5 items', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (51, 'Selling Req 3', 'Sell 20 items', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (52, 'Joke Req 1', 'Make 1 person laugh', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (53, 'Joke Req 2', 'Make 5 people laugh', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (54, 'Joke Req 3', 'Make 20 people laugh', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (55, 'Swim Req 1', 'Swim with floaters', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (56, 'Swim Req 2', 'Swim without floaters for 1 min', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (57, 'Swim Req 3', 'Swim all day without floaters', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (58, 'Bike Req 1', 'Ride with training wheels', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (59, 'Bike Req 2', 'Ride once without training wheels', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (60, 'Bike Req 3', 'Ride all day without training wheels', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (61, 'Exercise Req 1', 'Do 5 pushups and 5 situps', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (62, 'Exercise Req 2', 'Do 20 pushups and 20 situps', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (63, 'Exercise Req 3', 'Do 100 pushups and 100 situps', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (64, 'Eat Req 1', 'Eat healthy for one day', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (65, 'Eat Req 2', 'Eat healthy for one week', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (66, 'Eat Req 3', 'Eat healthy forever', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (67, 'Pet Req 1', 'Choose a pet and research your chosen pet', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (68, 'Pet Req 2', 'Get your pet ', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (69, 'Pet Req 3', 'Love your pet', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (70, 'Guitar Req 1', 'Learn Strings', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (71, 'Guitar Req 2', 'Learn 5 chords', 0);
INSERT INTO `requirement` (`id`, `name`, `description`, `isComplete`) VALUES (72, 'Guitar Req 3', 'Play a basic song', 0);
