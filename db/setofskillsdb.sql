...
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (6, 'Laundry', 'From sweaty socks to food-stained t-shirts, from bed sheets to bath mats, there\'s always something that can be washed (or folded or ironed). One way to lighten the work load? Recruit your kids to take a turn doing the laundry.', 'Laundry is something that everyone in the household contributes to, no matter their age or hobbies.', NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (7, 'Gift wrapping', 'Gift giving is an act of self-gratification. It is a good way of strengthening relationships. If you are in a friendship or a relationship, you should always show the other person how much you care for him or her. You don\'t need to wait for an occasion in order to give a gift.', 'Learn to wrap a present professionally.', NULL);
...
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (9, 'Bake a loaf of bread', 'Nothing beats the flavor & taste coming from that freshly baked bread straight from out of your oven. The mouth-watering taste and aroma of newly-baked bread with some butter slowly melting atop is one thing you cannot experience outside your home.', 'Create your very own bread.', NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (10, 'Clean your room', 'We all make the messes, eat the food, wear the clothes, dirty the dishes. We all need to contribute with cleaning up after ourselves.', 'An important part of a young person’s development, cleaning up a mess they\'ve made themselves.', NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (11, 'Fishing', 'But teach a kid how to fish, and you’ve helped create a lifetime of learning, amazing experiences out on the water, and memories that will last for as long as they live… \n\n', 'Give a kid a fish and you’ve fed him or her for one meal…', NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (12, 'Sing', 'If you start teaching kids to sing young, this can foster a lifelong love of music. Start with basic notes and keys and then teach children a few songs and exercises. As singing is a technical skill, professional can help to really develop children\'s voices.', 'Singing is an invaluable skill that many children love to learn. ', NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (13, 'Dance', 'There are the obvious benefits of studying dance; reduced obesity, a fun source of exercise, healthy blood pressure and cholesterol levels, and helping to maintain a balanced lifestyle. There is clinically significant evidence that children who participate actively in the performing arts spend less time sitting in front of a computer screen playing games and therefore are at less of a risk of developing health problems', 'Keeping active – both physically and mentally', NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (14, 'Hiking', 'The greatest way to impart wonder and wanderlust in younger family members is to get them out on the trail. ', 'Hiking with kids . . . is fun . . . seriously it can be! ', NULL);
...
INSERT INTO `skill` (`id`, `name`, `description`, `summary`, `prerequisite_skill_id`) VALUES (16, 'Sewing', 'Put your needle and thread to work on handmade accessories, clothing, stuffed toys, blankets, and backpacks for the kids in your life.', 'Kids are never too young when it comes to learning crafts, especially sewing.', NULL);
...
INSERT INTO `achiever` (`id`, `user_id`, `firstname`, `lastname`, `age`, `login_time`, `image_link`) VALUES (4, 4, 'brandenprofile', NULL, NULL, NULL, NULL);
INSERT INTO `achiever` (`id`, `user_id`, `firstname`, `lastname`, `age`, `login_time`, `image_link`) VALUES (5, 5, 'mark ', NULL, NULL, NULL, NULL);
